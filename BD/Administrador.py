...
def deleteAdmin():
    con4=connect("C:\PINZON\sqlite-tools-win32-x86-3400100\DB\Hotel.db")
...
def deleteMesero():
    con5=connect("C:\PINZON\sqlite-tools-win32-x86-3400100\DB\Hotel.db")
...
def deleteRecepcionista():
    con6=connect("C:\PINZON\sqlite-tools-win32-x86-3400100\DB\Hotel.db")
...
def deleteOferta():
    con8=connect("C:\PINZON\sqlite-tools-win32-x86-3400100\DB\Hotel.db")
...
def readOferta():
    con9=connect("C:\PINZON\sqlite-tools-win32-x86-3400100\DB\Hotel.db")
...
def updateOferta():
    while True:
        interfaz("cls")
        con10=connect("C:\PINZON\sqlite-tools-win32-x86-3400100\DB\Hotel.db")
